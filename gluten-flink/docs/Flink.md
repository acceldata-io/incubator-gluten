...
ln -s $GLUTEN_FLINK_HOME/runtime/target/gluten-flink-runtime-1.7.0.3.3.6.6.jar $FLINK_HOME/gluten_lib/gluten-flink-runtime-1.6.0.jar
ln -s $GLUTEN_FLINK_HOME/loader/target/gluten-flink-loader-1.7.0.3.3.6.6.jar $FLINK_HOME/gluten_lib/gluten-flink-loader-1.6.0.jar
```
